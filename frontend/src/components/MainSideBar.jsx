  ...
  return (
    <div className="bg-black">
      ...
      <div className=" flex flex-col bg-black">
        <aside className="flex flex-col shrink-0 lg:w-[300px] w-[250px]  m-0 fixed  bg-purple-200 border-r border-r-dashed border-r-neutral-200  min-h-full">
          <div className="hidden border-b border-dashed lg:block dark:border-neutral-700/70 border-neutral-200"></div>

          <div className="flex items-center justify-between px-8 py-5 bg-purple-400 rounded-lg">
            <Link
              to={`/profile/${user?.id}`}
