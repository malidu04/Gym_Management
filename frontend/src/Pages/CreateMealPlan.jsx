        ...
        <form onSubmit={handleSubmit}>
          <div className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md">
            ...
            <button
              ...
              className="w-full px-4 mt-2 py-2 text-sm font-medium text-black bg-red-500 rounded-md shadow hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Cancel
            </button>
          </div>
